...
$0.97\pm0.01$ of the imposed strain (measured as described for the free case
below).
...
of a compact particle. On the ridge axis the ridge and the sphere agree within a factor of two
...
sphere over the same distances. A two-dimensional elastic calculation for the ridge
...
$0.97\pm0.01$ in the held cell. When the springs are removed and the inclusion is free to relax, the ridge
...
settles by 13~\AA{} in the same interval and then holds. It
